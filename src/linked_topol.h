...
void add_topology_backward_gibbs (topology t, phylogeny_gibbs *segment, linked_topol tp, split_space split);
void accept_add_topology_forward_gibbs  (topology t, phylogeny_gibbs *segment);
void accept_add_topology_backward_gibbs (topology t, phylogeny_gibbs *segment);
void reject_add_topology_forward_gibbs  (topology t, phylogeny_gibbs *segment, linked_topol tp);
void reject_add_topology_backward_gibbs (topology t, phylogeny_gibbs *segment, linked_topol tp);

void remove_topology_forward_gibbs  (topology t, phylogeny_gibbs *segment, linked_topol tp, split_space split);
void remove_topology_backward_gibbs (topology t, phylogeny_gibbs *segment, linked_topol tp, split_space split);
void accept_remove_topology_forward_gibbs  (topology t, phylogeny_gibbs *segment, linked_topol tp);
void accept_remove_topology_backward_gibbs (topology t, phylogeny_gibbs *segment, linked_topol tp );
void reject_remove_topology_forward_gibbs  (topology t, phylogeny_gibbs *segment, linked_topol tp);
void reject_remove_topology_backward_gibbs (topology t, phylogeny_gibbs *segment, linked_topol tp);

void shift_topology_forward_gibbs  (topology rt, phylogeny_gibbs *segment, linked_topol tp, split_space split);
void shift_topology_backward_gibbs (topology lt, phylogeny_gibbs *segment, linked_topol tp, split_space space);
void accept_shift_topology_forward_gibbs  (topology rt, phylogeny_gibbs *segment, linked_topol tp);
void accept_shift_topology_backward_gibbs (topology lt, phylogeny_gibbs *segment, linked_topol tp);
void reject_shift_topology_forward_gibbs  (topology rt, phylogeny_gibbs *segment, linked_topol tp);
void reject_shift_topology_backward_gibbs (topology lt, phylogeny_gibbs *segment, linked_topol tp);

void   swap_likelihood_gibbs (topology old, phylogeny_gibbs *segment, topology t);
void unswap_likelihood_gibbs (topology old, phylogeny_gibbs *segment, topology t);
void link_current_to_accepted_gibbs (topology t, phylogeny_gibbs *segment);
void link_accepted_to_current_gibbs (topology t, phylogeny_gibbs *segment);

void sum_segment_likelihood_gibbs (topology t, phylogeny_gibbs *segment);


/*------------------------------------
  By Yujin Chung on 2/7/2013
  All the following functions are from biomc2-1.9
---------------------------------------- */
