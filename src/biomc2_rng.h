...
double biomc2_rng_uniform (biomc2_rng r); // YC 5/24/2017

/*! \brief Returns a positive random number between 0 and 1 (inclusive). */
// inline double biomc2_rng_uniform_pos (biomc2_rng r); // YC 5/24/2017
double biomc2_rng_uniform_pos (biomc2_rng r);

/*! \brief Returns an integer random number between 0 and n (exclusive). */
// inline unsigned long int biomc2_rng_uniform_int (biomc2_rng r, unsigned long int n); // YC 5/24/2017
