...
/*-----------------------------------------------
  By Yujin Chung on 2/6/2013:
  All the following functions and objects are from biomc2-1.9
--------------------------------------------------- */
...
void
ln_likelihood_moved_branches_nodata (phylogeny *p, topology t) { return; }
void 
ln_likelihood_proposal_nodata (phylogeny p, topology t) { return; }
